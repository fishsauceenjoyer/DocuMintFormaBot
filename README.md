...
Telegram-бот для автоматизации приёма заказов на оформление документов (Санэпид/СК, BHP, demo_code, психотесты и др.).
...
ROUTING_demo_category=-100123456789       # Чат для Санэпид/СК
ROUTING_BHP=-100987654321           # Чат для BHP
ROUTING_PSYCHOTESTS=123456789       # Чат для психотестов
ROUTING_demo_code=-100123456788         # Чат для demo_code
...
| 🧧 demo_code без присутствия | 200 zł |

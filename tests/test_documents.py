...
class TestGetAllTemplates:
    ...
    def test_includes_demo_service(self):
        """Verify 'demo_service' is in the list."""
        from templates.documents import get_all_templates
        codes = [code for code, _ in get_all_templates()]
        assert "demo_service" in codes

    def test_includes_demo_document(self):
        """Verify 'demo_document' is in the list."""
        from templates.documents import get_all_templates
        codes = [code for code, _ in get_all_templates()]
...
class TestGetTemplate:
    ...
    def test_returns_dict_for_demo_service(self):
        """Verify get_template('demo_service') returns a dict with expected keys."""
    ...
    def test_returns_dict_for_demo_document(self):
        """Verify get_template('demo_document') returns a dict."""
        from templates.documents import get_template
        template = get_template("demo_document")
        assert template is not None
        assert "name_en" in template
        assert "fields" in template

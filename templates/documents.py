...
Содержит описание типов документов (санэпид, BHP, психотесты, demo_code),
...
DOCUMENT_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "demo_category": {
        ...
        "fields": [
            ...
            Field("full_name", "👤 Фамилия и имя как в заграндокументе", "text"),
            Field("birth_date", "🎂 Дата рождения (ДД.ММ.ГГГГ)", "date"),
            Field("demo_code", "🆔 demo_code или серия/номер документа", "text"),
            Field(
                "address",
    ...
    "bhp": {
        ...
        "fields": [
            ...
            Field("demo_code", "🆔 demo_code", "text"),
    ...
    "demo_code": {
        "name": "🧧 demo_code без присутствия",
        "price": 200,
        "fields": [
            Field("full_name", "👤 ФИО", "text"),
...
def get_template(doc_type: str) -> Optional[Dict[str, Any]]:
    ...
    Args:
        doc_type: Код типа документа (demo_category, bhp, psychotests, demo_code).

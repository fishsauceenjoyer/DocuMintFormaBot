...
ROUTING = {
    "demo_category": int(os.getenv("ROUTING_demo_category", "-100123456789")),
    "bhp": int(os.getenv("ROUTING_BHP", "-100987654321")),
    "psychotests": int(os.getenv("ROUTING_PSYCHOTESTS", "123456789")),
    "demo_code": int(os.getenv("ROUTING_demo_code", "-100123456788")),
...
def validate_config() -> None:
    ...
    for key, chat_id_value in [
        ("ROUTING_demo_category", ROUTING.get("demo_category")),
        ("ROUTING_BHP", ROUTING.get("bhp")),
        ("ROUTING_PSYCHOTESTS", ROUTING.get("psychotests")),
        ("ROUTING_demo_code", ROUTING.get("demo_code")),
